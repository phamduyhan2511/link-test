...
import wizardStyle from "wizardStyle.jsx";
...
class Wizard extends React.Component {
  ...
  finishButtonClick() {
    if (
      (this.props.validate && ((this[this.props.steps[this.state.currentStep].stepId].isValidated !==
        undefined &&
        this[this.props.steps[this.state.currentStep].stepId].isValidated()) ||
        this[this.props.steps[this.state.currentStep].stepId].isValidated ===
          undefined) || this.props.validate === undefined) &&
            ...
            {steps.map((prop, key) => {
              ...
              return (
                <div className={stepContentClasses} key={key}>
                  <prop.stepComponent
                    stepProps = {this.props.steps[key].stepProps}
