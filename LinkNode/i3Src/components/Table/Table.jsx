...
import TableHead from "../../../i3NodeModules/@material-ui/core/TableHead";
  ...
  return (
    <div className={classes.tableResponsive}>
      <Table className={classes.table}>
        {tableHead !== undefined ? (
          <React.Fragment>
            { gridColls !== undefined && gridColls.length > 0
                ?<colgroup>
                    {
                        gridColls.map(w => {
                            return (
                                <col key={ehealth.guid.get()} style={{ width: `${w}%` }} />
                            )
                        })
                    }
                </colgroup>
            ...
            <TableHead className={classes[tableHeaderColor]}>
              <TableRow className={classes.tableRow}>
                {tableHead.map((prop, key) => {
                  ...
                  return (
                    <TableCell className={tableCellClasses} key={key} onClick={()=>{
                        if (props.handleSort !== null) {
