...
class P3DetailForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
            ...
            <Card >
              ...
              <CardFooter stats>
                <div className={classes.stats}>
                  ...
                  <a href="#pablo" onClick={e => e.preventDefault()}> Lương theo vị trí  </a>
                </div>
              </CardFooter>
            </Card>
          </GridItem>
            ...
            <Card  >
              ...
              <CardFooter stats>
                <div className={classes.stats}>
                  ...
                  <a href="#pablo" onClick={e => e.preventDefault()}>Lương theo kiến thức</a>
                </div>
              </CardFooter>
            </Card>
          </GridItem>
            ...
            <Card> 
              ...
              <CardFooter stats>
                <div className={classes.stats}>
                  ...
                  <a href="#pablo" onClick={e => e.preventDefault()}>Lương theo KPI</a>
                </div>
              </CardFooter>
...
export default withStyles(useStyles)(P3DetailForm);