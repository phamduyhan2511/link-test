...
import {
    ...
    dangerColor,
    colors
} from "i3MaterialDashboardStyles.jsx";
...
function rgb2rgbaStr(r, g, b, a){
    return `rgba(${r}, ${g}, ${b}, ${a})`;
}

Object.keys(colors).forEach(i => {
    var rgb = hexToRgb(colors[i]);
    var str = `rgba(${rgb.r}, ${rgb.g}, ${rgb.b},`;
    x[i] = {
...
const primaryRbg = hexToRgb(primaryColor);
const primaryRbga = a => rgb2rgbaStr(primaryRbg.r, primaryRbg.g, primaryRbg.b, a);
var buttonStyle = {
    button: {
        minHeight: "auto",
        minWidth: "auto",
    ...
    primary: {
        ...
        boxShadow:
            `0 2px 2px 0 ${primaryRbga(0.14)}, 0 3px 1px -2px ${primaryRbga(0.2)}, ${primaryRbga(0.12)}`,
        "&:hover,&:focus": {
            backgroundColor: primaryColor,
            boxShadow:
                `0 14px 26px -12px ${primaryRbga(0.42)}, 0 4px 23px 0px ${primaryRbga(0.12)}, 0 8px 10px -5px ${primaryRbga(0.2)}`
        }
    },
    secondary: {
        backgroundColor: '#ffffff',
        boxShadow:
            "0 2px 2px 0 rgba(153, 153, 153, 0.4), 0 3px 1px -2px rgba(153, 153, 153, 0.45), 0 1px 5px 0 rgba(153, 153, 153, 0.45)",
        "&:hover,&:focus": {
            backgroundColor: '#ffffff',
            boxShadow:
                "0 2px 2px 0 rgba(153, 153, 153, 0.14), 0 3px 1px -2px rgba(153, 153, 153, 0.2), 0 1px 5px 0 rgba(153, 153, 153, 0.12)"
